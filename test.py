...
def val(args):
    ...
    mIoU = np.mean(iou)
    # print('mIoU: ', mIoU)
    print("group0_mIou", evaluations.group_mean_iou[0])
    print("group1_mIou", evaluations.group_mean_iou[1])
    print("group2_mIou", evaluations.group_mean_iou[2])
    print("group3_mIou", evaluations.group_mean_iou[3])
